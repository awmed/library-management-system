...
public class CheckReserved extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel35.setText("Reserved Books");
        ...
        reservationTable.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Reservation ID", "Member ID", "Book ID", "Date Reserved"
            }
        ) {
        ...
        reservationTable.setIntercellSpacing(new java.awt.Dimension(5, 5));
        reservationTable.setRowHeight(25);
        reservationTable.setSelectionBackground(new java.awt.Color(153, 153, 153));
        reservationTable.setShowGrid(true);
        reservationTable.getTableHeader().setReorderingAllowed(false);
        jScrollPane1.setViewportView(reservationTable);

        jPanel1.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 190, 579, 342));

        jLabel4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/main/icons/reservation.png"))); // NOI18N
        ...
        jPanel1.add(btnRefresh, new org.netbeans.lib.awtextra.AbsoluteConstraints(590, 120, 50, 50));
    ...
    public void reserved() {
        try {
            ...
            String select = "SELECT RES_ID AS RESERVATION_ID,MEM_ID AS MEMBER_ID,BOOK_ID,DATE_RES AS DATE_RESERVED FROM RESERVATION";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CheckReserved.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
