...
public class SearchBookMember extends javax.swing.JFrame {

    int xx, xy;
    Connection con;
    
    public SearchBookMember() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SearchBookMember.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
