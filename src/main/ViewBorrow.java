...
public class ViewBorrow extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/main/icons/borrowed books.png"))); // NOI18N
        ...
        borrowTable.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Borrow ID", "Member ID", "Book ID", "Date Borrowed", "Date Due"
            }
        ) {
        ...
        jPanel1.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 190, 579, 342));
    ...
    public void viewBorrow() {
        ...
        try {
            ...
            String select = "SELECT BORROW_ID,MEM_ID AS MEMBER_ID,BOOK_ID,DATE_BORROWED,DATE_DUE FROM BORROW";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ViewBorrow.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
