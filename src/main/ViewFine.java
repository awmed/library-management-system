...
public class ViewFine extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/main/icons/view fine.png"))); // NOI18N

        jLabel35.setBackground(new java.awt.Color(255, 255, 255));
        jLabel35.setFont(new java.awt.Font("Oriya MN", 1, 24)); // NOI18N
        jLabel35.setForeground(new java.awt.Color(255, 255, 255));
        jLabel35.setText("View Fine Payments");
        ...
        fineTable.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Fine ID", "Member ID", "Book ID", "Date Fined", "Amount"
            }
        ) {
        ...
        fineTable.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
        fineTable.setIntercellSpacing(new java.awt.Dimension(5, 5));
        fineTable.setRowHeight(25);
        fineTable.setSelectionBackground(new java.awt.Color(153, 153, 153));
        fineTable.setShowGrid(true);
        fineTable.getTableHeader().setReorderingAllowed(false);
        jScrollPane1.setViewportView(fineTable);

        jPanel1.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 200, 579, 342));
        ...
        jPanel1.add(btnRefresh, new org.netbeans.lib.awtextra.AbsoluteConstraints(600, 130, 50, 50));
    ...
    public void viewFines() {
        try {
            ...
            String select = "SELECT FINE_ID,MEM_ID AS MEMBER_ID,BOOK_ID,DATE_FINED,AMOUNT FROM FINES";
